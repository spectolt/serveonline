<section class="group__tab hidden" id="prisijungimas">
    ...
    <div class="company__inputs-container company__inputs-container--login">
        ...
        <div class="company__password-container">
            <p>Naujas slaptažodis, ne mažiau 8 simbolių.</p>
            <div class="input-container input-container--password-lock">
                <input type="password" name="password" placeholder="Naujas slaptažodis">
                <span class="input-icon"></span>
            </div>
            <div class="input-container input-container--password-lock">
                <input type="password" name="password" placeholder="Pakartokite slaptažodį">
                <span class="input-icon"></span>
            </div>
        </div>
